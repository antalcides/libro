...
\end{nota}
\lipsum[4]
\begin{teo}{Teorema del sucesor}{sucesor}
...
\vspace{20pt}
\begin{axioma}{\mbox{}}
Existe un conjunto $I\!N\neq\emptyset$ llamado conjunto de los números Naturales.

Podríamos decir que este axioma establece uno de los términos no definidos de la teoría el cual es el número natural.
\end{axioma}
